# Mini-guía «¿Qué es la IA?» — COCO GO

- **URL viva (post-PUBLICAR):** https://coco-go.lat/ia-intro/
- **Rol:** tope de embudo, **gratis y abierta** (sin captura de email, sin gate `?k=`).
- **H1:** ¿Qué es la IA?
...
- **Código de acceso:** ninguno (producto abierto).
- **Siguiente paso de fábrica:** verificadores CONTENIDO-EN-HTML + DISEÑO ≥90 (frescos, ajenos) → gate visual Pablo → PUBLICAR.
